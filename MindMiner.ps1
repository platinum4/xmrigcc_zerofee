...
while ($true)
{
	...
	if (!$FastLoop) {
		...
		$AllAlgos.Add("Mapping", [ordered]@{
			...
			"x16rtgin" = "X16rt"
			"yespower2b" = "Power2b"
			"yespowerinterchained" = "Interchained"
			"zelhash" = "Equihash125"
			"zhash" = "Equihash144"
			"blocx_autolykos2" = "Blocx"
			"progpow_telestai" = "Meraki"
			"progpow-telestai" = "Meraki"
			"xelishashv2_pepew" = "Pepew"
			"xelisv2-pepew" = "Pepew"
		})
		# disable asic algorithms
		$AllAlgos.Add("Disabled", @("bcd", "beam", "bitcore", "blake", "blake2b", "blake2s", "handshake", "kadena", "sha256", "sha256asicboost", "sha256-ld", "scrypt", "scrypt-ld", "tensority", "x11", "x11-ld", "x13", "x14", "x15", "quark", "qubit", "myrgr", "lbry", "decred", "sia", "blake", "nist5", "cryptonight", "cryptonightr", "cryptonightv7", "cryptonightv8", "x11gost", "groestl", "eaglesong", "equihash", "lyra2re2", "lyra2z", "pascal", "keccak", "keccakc", "skein", "c11", "timetravel", "skunk", "alph", "kaspa", "sha3d", "karlsen", "pyrin"))
