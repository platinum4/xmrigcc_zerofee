...
#	$Cfg.SpecifiedCoins = @{ "Equihash144" = "BTCZ"; "Equihash192" = "YEC"; "Ghostrider" = "RTM"; "Kawpow" = "RVN"; "MinotaurX" = "MAZA"; "Yescrypt" = "BSTY"; "Yescryptr16" = "BTE" }
#}
...
$Currency = $RequestCurrency | Get-Member -MemberType NoteProperty | Select-Object -ExpandProperty Name | ForEach-Object {
	if ($RequestCurrency.$_.algo -and !($RequestCurrency.$_.only_direct -eq "1")) {
		[PSCustomObject]@{
