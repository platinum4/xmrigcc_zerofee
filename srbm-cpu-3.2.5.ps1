...
#                if ("xelishashv2_pepew" -contains $_.Algorithm) { $_.Algorithm = "xelishashv2" }
				...
				elseif (("dutahashv4", "flex", "randomhscx", "yespowereqpay") -contains $_.Algorithm) { $fee = 2 }
				elseif (("xelishash", "xelishashv2_pepew", "xelishashv3") -contains $_.Algorithm) { $fee = 1.5 }
				elseif (("autolykos2", "blake3_decred", "karlsenhashv2", "nxlhash", "randomalpha", "randomy", "rinhash", "verthash", "walahash") -contains $_.Algorithm) { $fee = 1 }
