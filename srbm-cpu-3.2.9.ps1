...
$Cfg = ReadOrCreateMinerConfig "Do you want use to mine the '$Name' miner" ([IO.Path]::Combine($PSScriptRoot, $Name + [BaseConfig]::Filename)) @{
	...
	Algorithms = @(
		...
		[AlgoInfoEx]@{ Enabled = $true; Algorithm = "argon2id_exfer" }
...
#                if ("xelishashv2_pepew" -contains $_.Algorithm) { $_.Algorithm = "xelishashv2" }
				if (("argon2id_exfer", "xhash") -contains $_.Algorithm) { $fee = 3 }
                ...
                [MinerInfo]@{
					...
					Type = [eMinerType]::CPU
					API = "srbm2"
					URI = "https://github.com/doktor83/SRBMiner-Multi/releases/download/3.2.9/SRBMiner-Multi-3-2-9-win64.zip"
